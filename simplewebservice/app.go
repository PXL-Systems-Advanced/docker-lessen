...
func main() {
	...
	for {
		...
		counter++
		if counter == 5 {
			message, _ := base64.StdEncoding.DecodeString("RGUgZ2VoZWltZSBib29kc2NoYXAgaXM6ICdIaWVyIGthbiBqZSBkZSBzb3VyY2UgY29kZSB2aW5kZW46IGh0dHBzOi8vZ2l0aHViLmNvbS9QWEwtU3lzdGVtcy1BZHZhbmNlZC9kb2NrZXItbGVzc2VuJw==")
